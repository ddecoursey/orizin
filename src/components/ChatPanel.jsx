...
function pageHints(view, symbol) {
  ...
  // screener (default)
  return {
    tagline: "Suggests filters. Never changes your Conviction lens. Always asks first.",
    suggestions: [
            ...
            >
              {msg.role === "user" ? (
                ...
                <>
                  ...
                  {/* Stopped by the user mid-stream */}
                  {msg.stopped && (
                    <div className="mt-1.5 text-[9px] text-gray-500 italic">⏹ Stopped</div>
                  )}
        ...
        <div className="flex gap-2">
          ...
          {chat.isStreaming ? (
            <button
              ...
              title="Stop Ori"
              aria-label="Stop Ori"
              className="px-4 lg:px-3 py-2 bg-gray-700 text-gray-100 text-xs font-medium rounded-lg active:scale-95
                hover:bg-gray-600 transition-colors inline-flex items-center gap-1.5"
            >
