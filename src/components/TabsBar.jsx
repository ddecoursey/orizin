    ...
    <div className="flex items-center gap-1.5 px-3 py-2 border-b border-gray-800
      ...
      {adding ? (
        <input
          ...
          className="px-3 py-1 rounded-full text-xs bg-gray-800 border border-blue-500
        ...
        <button
          ...
          className="px-3 py-1 rounded-full text-xs font-medium text-blue-400
            border border-dashed border-blue-800 hover:bg-blue-900/30 transition-colors"
        >
          + Save screen
        </button>
      )}
